...
-(NSString *)starImageUrl
{
//    NSString * url = nil;
    if (_randomImages.count>0) {
        return  _randomImages[0];
    }
    return nil;
}
...
//    _bgImageView.image = [self starImageUrl];
//    _bgImageView
 
    [_bgImageView sd_setImageWithURL:[NSURL URLWithString:[self starImageUrl]] placeholderImage:[UIImage imageNamed:@"startImage3"]];
